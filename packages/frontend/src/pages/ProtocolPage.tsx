    ...
    <div className="min-h-screen pt-28 pb-16 bg-[#050b08]">
      ...
      <section className="max-w-5xl mx-auto px-6 mb-20 text-center">
        <div className="inline-flex items-center gap-2 border border-[#10b981]/30 bg-[#10b981]/10 rounded-full px-4 py-1.5 mb-6">
          ...
          <span className="text-xs font-bold text-[#34d399] uppercase tracking-widest">Live on GIWA Sepolia</span>
        </div>
        <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight mb-4">The GigLock Protocol</h1>
      ...
      <section className="max-w-5xl mx-auto px-6 mb-20">
        <h2 className="text-xs font-bold text-[#10b981] uppercase tracking-widest mb-6">Smart Contracts</h2>
        <div className="grid md:grid-cols-2 gap-4">
          {CONTRACTS.map((c) => (
            <div key={c.name} className="rounded-2xl border border-[#10b981]/15 bg-[#09140e] p-6 hover:border-[#10b981]/35 transition-all group">
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="flex items-center gap-3">
                  <div className="size-10 rounded-xl flex items-center justify-center text-xs font-black"
                ...
                <a
                  ...
                  className="text-xs font-mono text-[#34d399] hover:underline transition-colors truncate max-w-[160px]"
                >
                  {c.address}↗
                </a>
              </div>
      ...
      {/* Flow */}
      <section className="max-w-5xl mx-auto px-6 mb-20">
        <h2 className="text-xs font-bold text-[#10b981] uppercase tracking-widest mb-6">Escrow Lifecycle</h2>
      ...
      {/* Security */}
      <section className="max-w-5xl mx-auto px-6 mb-20">
        <h2 className="text-xs font-bold text-[#10b981] uppercase tracking-widest mb-6">Security Model</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {SECURITY.map((s) => (
            <div key={s.label} className="rounded-2xl border border-[#10b981]/15 bg-[#09140e] p-5 hover:border-[#10b981]/30 transition-all">
      ...
      <section className="max-w-5xl mx-auto px-6">
        <div className="rounded-3xl border border-[#10b981]/25 bg-[#09140e] p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-[#10b981]/5">
          ...
          <div className="flex gap-3 shrink-0">
            ...
            <Link to="/developers">
              <button className="btn-outline text-xs">View ABIs</button>
            </Link>
          </div>
        </div>
      </section>
